 ...
 * The Board — /api/state
 *
 * Cloudflare Pages Function. Replaces the critic_board.json file the Python
 * version kept on the PC. Same shape of data, same two verbs, so the app in
 * public/index.html talks to this exactly the way it talked to the local server.
 *
 * Bindings this expects (set in the Pages project settings):
